...
public:
	...
	void AddTopObject(std::string filename);
...
protected:
	...
	Utility::GPUVariable *_texture0, *_texture1, *_texture2, *_texture3, *_topObject;
...
private :
	...
	enum constants { number_of_models = 4 };
	...
	/// This is one above the top object that should be shown
	/// e.g. so if this value is 0, no object is shown, if it's 1 only the first object is shown etc
	int _topObjectValue;
