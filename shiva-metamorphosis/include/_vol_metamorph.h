...
struct VOL_METAMORPH_API metamorph_params 
{
	...
	float m_alpha; //for linear metamorph
	//anything else?
};

VOL_METAMORPH_API bool openVol(const char * filename, unsigned int resolution_x, unsigned int resolution_y, unsigned int resolution_z, float** o_bbox, float** o_array);
